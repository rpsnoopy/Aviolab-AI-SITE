...
- **Current Version**: v1.2.05 - Aggiunto `text-wrap: balance` alla mission-quote (`.mission-quote`) per distribuire più armoniosamente le righe del citato su più larghezze di viewport.
- **Previous Version**: v1.2.04 - Hero CTA dei due prodotti ora affiancati side-by-side su desktop (flex-row con wrap, max-width 640px) anziché impilati verticalmente; collasso automatico in stack a tutta larghezza sotto i 600px. Dimensioni label/sub ricalibrate per il nuovo layout orizzontale.
