...
- **Current Version**: v1.3.19 - `dicono-di-noi.html`: spaziature verticali ridotte (`.dn-section` da 4.5rem a 3.5rem, `#rassegna` padding-bottom 2.5rem, `#contatti-stampa` padding-top 3rem): fra l'ultima scheda della rassegna e «Contatti per la stampa» c'era troppo vuoto. Footer delle 7 pagine a v1.3.19.
