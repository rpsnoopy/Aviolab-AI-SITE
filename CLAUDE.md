...
- **Current Version**: v1.3.25 - `dicono-di-noi.html`: aggiunto il **post della pagina Facebook del Comune di Pieve Ligure** (1/9/2026 sera, icona `fab fa-facebook`, tipo «Pagina Facebook», JSON-LD `SocialMediaPosting`), fra Liguria24 e Genova Quotidiana. Dieci voci. Footer delle 7 pagine a v1.3.25.
