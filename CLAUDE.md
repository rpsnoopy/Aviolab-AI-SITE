...
- **Current Version**: v1.1.63 - Aggiunta gestione esplicita Downloads link per Edge con window.open
- **Previous Version**: v1.1.62 - Fix navigazione Downloads per compatibilità Microsoft Edge
