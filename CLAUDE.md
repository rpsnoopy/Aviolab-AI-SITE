...
- **Current Version**: v1.3.20 - `dicono-di-noi.html`, card «Materiali»: due voci accorciate per stare su una riga («Che cos'è TTR-SUITE, in linguaggio piano», «Brochure, scheda AGID, documenti AI Act e GDPR») e rientro sospeso sulle righe dei contatti (`padding-left`/`text-indent`), così un eventuale a capo rientra sotto il testo e non sotto l'icona. Footer delle 7 pagine a v1.3.20.
